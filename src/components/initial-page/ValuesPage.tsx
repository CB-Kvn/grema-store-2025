...
import { 
  Heart, Shield, Sparkles, Gem, Leaf, HandHeart, 
  Users, Scale, ArrowRight, Diamond 
} from 'lucide-react';
  ...
  const values = [
    {
      ...
      description: "Nos esforzamos constantemente por superar las expectativas, creando piezas que reflejen la más alta calidad artesanal."
    },
    {
      icon: Shield,
      title: "Integridad",
      description: "Mantenemos los más altos estándares éticos en todas nuestras operaciones, desde la selección de materiales hasta el servicio al cliente."
    },
    {
      icon: Sparkles,
      title: "Innovación",
      description: "Combinamos técnicas tradicionales con tecnología moderna para crear diseños únicos y contemporáneos."
    },
    {
      icon: Leaf,
      title: "Sostenibilidad",
      description: "Nos comprometemos con prácticas sostenibles y responsables en toda nuestra cadena de producción."
    },
    {
      icon: HandHeart,
      title: "Responsabilidad Social",
      description: "Contribuimos activamente al bienestar de nuestra comunidad y apoyamos causas sociales importantes."
    },
    {
      icon: Scale,
      title: "Transparencia",
      description: "Mantenemos una comunicación clara y honesta con nuestros clientes sobre nuestros procesos y materiales."
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-xl text-primary-600">
              Los principios que guían cada aspecto de nuestro trabajo y definen quiénes somos.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div>
              ...
              <p className="mt-4 text-lg text-primary-300">
                Cada pieza que creamos es un testimonio de nuestro compromiso con la excelencia. 
                Utilizamos solo los mejores materiales y aplicamos técnicas artesanales 
                perfeccionadas a lo largo de generaciones.
              </p>
              <div className="mt-8">
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-4 max-w-2xl mx-auto text-xl text-primary-600">
              Trabajamos activamente para minimizar nuestro impacto ambiental y promover prácticas sostenibles.
            </p>
          </div>
          <div className="mt-12 grid grid-cols-1 gap-8 md:grid-cols-3">
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-primary-900">Materiales Sostenibles</h3>
              <p className="mt-2 text-primary-600">
                Utilizamos materiales reciclados y de origen ético cuando es posible.
              </p>
            </div>
            <div className="text-center">
              <div className="bg-primary-50 rounded-full p-6 w-24 h-24 mx-auto mb-4 flex items-center justify-center">
              ...
              <h3 className="text-lg font-medium text-primary-900">Comercio Justo</h3>
              <p className="mt-2 text-primary-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-primary-900">Transparencia</h3>
              <p className="mt-2 text-primary-600">
